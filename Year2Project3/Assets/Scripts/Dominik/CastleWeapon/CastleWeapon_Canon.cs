...
public class CastleWeapon_Canon : CastleWeapon
{
    ...
    public void FireProjectile()
    {
        ...
        GameObject newProjectile = ObjectPooler.instance.GrabFromPool("canon projectile", projectileSpawns[0].position, projectileSpawns[0].rotation);
