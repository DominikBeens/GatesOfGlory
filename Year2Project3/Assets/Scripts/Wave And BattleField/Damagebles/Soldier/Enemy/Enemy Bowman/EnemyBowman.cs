...
public class EnemyBowman : Enemy{
    ...
    public override IEnumerator Attack()
    {
        ...
        Transform _currentArrow = ObjectPooler.instance.GrabFromPool("Attacking Arrow", bowPos.position, Quaternion.Euler(Vector3.zero)).transform;
        ...
        _currentArrow.GetChild(0).position = bowPos.position;
